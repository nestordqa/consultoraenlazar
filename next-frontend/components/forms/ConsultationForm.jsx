...
const ConsultationForm = ({ handleCloseForm, input, handleInputChange }) => {
  return (
    <>
      <div className="fixed top-0 bottom-0 right-0 left-0 w-full h-full z-[1500] flex justify-center items-start bg-opacity-20 bg-black py-28 px-5">
        <div className="bg-white flex flex-col justify-center items-start w-full h-full md:h-[600px] md:w-3/4 lg:w-2/4 rounded-2xl m-4">
          <button
          ...
          <form className="flex flex-col justify-start items-center w-full h-3/4 pt-6 px-10 lg:px-20">
            ...
            <button className="bg-yellow rounded-2xl m-4 py-1 px-8 font-semibold uppercase self-center md:self-end">
              Enviar consulta
            </button>
          </form>
        </div>
