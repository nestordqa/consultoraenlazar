...
export const Feedback = () => {
  return (
    ...
    <h2 className="pt-10 px-4 md:px-8 text-1xl md:text-2xl font-bold text-center text-ellipsis opacity-90 text-yellow sm:text-sm">
      Te acompañamos siempre 

    </h2>
    <h2 className=" px-4 md:px-8 text-1xl md:text-2xl font-bold text-center text-ellipsis opacity-90 text-yellow">
      ¡Garantizamos tu aptendizaje!</h2> 
      
    <div className="flex justify-between items-center bg-blue p-10 text  flex-wrap">
    ...
    <h3 className="text-5xl font-bold m-0 text-yellow">+900</h3>
    <p className="text-lg m-0"><br/>Casi 1000 personas en nuestra comunidad</p>
    </div>
    </div>
