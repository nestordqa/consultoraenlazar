...
export const CompaniesThatTrust = ({ companies }) => {
  ...
  return (
    <div className="w-full h-auto bg-grey ">
      <h2 className="pt-10 px-4 md:px-8 text-2xl lg:text-3xl font-bold text-center text-ellipsis opacity-90 ">
        Empresas que confían en nosotros
      </h2>

      <div className=" w-full h-auto flex flex-col md:flex-row flex-wrap justify-center items-center p-4">
