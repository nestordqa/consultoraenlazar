  ...
  return (
   <div className="goal-container flex flex-wrap w-full h-auto ">
       ...
       <div className="goal-content w-full lg:w-1/2 pl-5 flex flex-col justify-center">
        <h2 className="text-2xl lg:text-3xl font-bold text-center text-ellipsis text-gray-800  mb-4 lg:mb-8">
          Somos Enlazar
        </h2>
        <p className="text-gray-800 text-base lg:text-lg mb-8 sm:mb-12">
        ...
        <div className="goal-button flex justify-center pb-5 pt-5">
          <Link href="/team">
